 ...
 *
 * Disassembly of DSDT.aml, Wed Jun 13 10:42:01 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001130B (70411)
 *     Revision         0x01 **** 32-bit table (V1), no 64-bit math support
 *     Checksum         0xDB
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-J5   "
 *     OEM Revision     0x00001310 (4880)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20120711 (538052369)
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-J5   ", 0x00001310)
{
    /*
    ...
    External (_SB_.PCI0.LPC_.TPM_._STA, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPC_.TPM_.BUF1, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPC_.TPM_.CMOR, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    ...
    External (_SB_.PCI0.VID_.DRDY, IntObj)    // Warning: Unknown object
    ...
    OperationRegion (MNVS, SystemMemory, 0x9CF7D018, 0x1000)
    ...
    OperationRegion (OEMN, SystemMemory, 0x9CF6AF18, 0x0014)
    ...
    OperationRegion (GNVS, SystemMemory, 0x9CF69C18, 0x036F)
    ...
    Scope (\)
    {
        ...
        OperationRegion (PMIO, SystemIO, 0x1800, 0x9F)
    ...
    Scope (\_SB)
    {
        ...
        Device (MEM)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                ElseIf (LNotEqual (\_SB.PCI0.LPC.TPM._STA, 0x0F))
                {
                    Store (0x01400000, MEL2)
                    Store (0x00, MEL3)
                }
        ...
        Scope (\)
        {
            ...
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x90, 0x12, 0x80, 0x01, 0x03, 0x00, 0x00, 0x00 
            })
            ...
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                /* 0008 */  0x93, 0x1C, 0x00, 0x02, 0x03, 0x00, 0x00, 0x00 
            })
        ...
        Device (PCI0)
        {
            ...
            Device (LPC)
            {
                ...
                Device (SIO)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        ElseIf (LEqual (\_SB.PCI0.LPC.TPM._STA, 0x0F))
                        {
                            Return (SCRS)
                        }
                        Else
                ...
                Device (MOU)
                {
                    Name (_HID, EisaId ("LEN2007"))  // _HID: Hardware ID
                    ...
                    Method (MHID, 0, Serialized)
                    {
                        If (\_SB.PCI0.LPC.PADD)
                        {
                            Store (0x0720AE30, _HID)
                        }
                        ElseIf (\_SB.PCI0.LPC.NFCD)
                        {
                            Switch (\_SB.PCI0.LPC.EC.CPID)
                            {
                                Case (0x01)
                                {
                                    Store (0x0C20AE30, _HID)
                                }
                                Case (0x02)
                                {
                                    Store (0x0720AE30, _HID)
                ...
                OperationRegion (IMGA, SystemMemory, 0xFF000300, 0x0100)
                ...
                Device (EC)
                {
                    ...
                    Method (_Q90, 0, NotSerialized)  // _Qxx: EC Query
                    {
                        If (\_SB.PCI0.LPC.DSPS)
                        {
                            ...
                            {
                                If (LNotEqual (\_SB.PCI0.PEG.VID.BADR, 0xFFFFFFFF))
                                {
                                    OperationRegion (AMSA, SystemMemory, \_SB.PCI0.PEG.VID.BADR, 0x00010000)
                    ...
                    {
                        Store (\_SB.PCI0.LPC.EC.CPUJ, Local0)
                        Store (\UCCT (Local0), Local1)
                        Store (Local1, \_SB.PCI0.LPC.EC.CTMP)
                    }
            ...
            Device (SMBU)
            {
                ...
                Device (NFC)
                {
                    Name (_HID, EisaId ("BCM2F2A"))  // _HID: Hardware ID
                    Name (_CID, EisaId ("BCM2F2A"))  // _CID: Compatible ID
                    Name (_UID, 0x00)  // _UID: Unique ID
                    Method (_STA, 0, NotSerialized)  // _STA: Status
                    {
                        If (LOr (\_SB.PCI0.LPC.NFCD, \NFCF))
                        {
                            Return (0x00)
                        }
                        Else
            ...
            Device (XHCI)
            {
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    If (LOr (LAnd (LEqual (PCHS, 0x02), LEqual (PCHG, 0x01)), LAnd (LEqual (PCHP, 0x40), LEqual (PCHG, 0x02))))
                    {
                        Store (\XWMB, Local3)
                        ...
                        {
                            Store (0x00, Local7)
                            While (LEqual (LAnd (LAnd (LAnd (PSC1, 0x00080000), LAnd (PSC2, 0x00080000)), LAnd (LAnd (PSC3, 0x00080000), LAnd (PSC4, 0x00080000))), 0x00))
                            {
                                Sleep (0x0A)
                                Increment (Local7)
                    ...
                    Device (SSP2)
                    {
                        ...
                        Scope (\_SB)
                        {
                            Device (VCAM)
                            {
                                ...
                                Method (_STA, 0, NotSerialized)  // _STA: Status
                                {
                                    And (\DT3D, 0x10, Local4)
                                    If (LEqual (Local4, 0x10))
                                    {
                                        And (\_SB.PCI0.XHCI.MBA1, 0xFFFF0000, Local5)
                                        If (LNotEqual (Local5, 0xFFFF0000))
                                        {
                                            OperationRegion (HCOR, SystemMemory, And (\_SB.PCI0.XHCI.MBA1, 0xFFFFFFF0), 0x0600)
                                            ...
                                            If (LNotEqual (Local0, 0x80))
                                            {
                                                If (LAnd (\CPUF, \WIN8))
                                                {
                                                    And (P3CS, 0x01, Local1)
                                                    If (LAnd (Local1, LNotEqual (P3CS, 0xFF)))
                                                    {
                                                        Or (\DT3D, 0x81, \DT3D)
                                                    }
                                                    Else
                                        ...
                                        And (\DT3D, 0x01, Local2)
                                        And (\DT3D, 0x08, Local3)
                                        If (LOr (LEqual (Local2, 0x01), LEqual (Local3, 0x08)))
                                        {
                                            Return (0x0F)
                                        }
                                        Else
                                    ...
                                    If (LEqual (Arg0, ToUUID ("f5cf0ff7-5d60-4842-82c0-fa1a61d873f2")))
                                    {
                                        Switch (ToInteger (Arg2))
                                        {
                                            ...
                                            Case (0x01)
                                            {
                                                ...
                                                {
                                                    Store (0x00, \_SB.PCI0.LPC.FW3D)
                                                    Store (0x00, IDFU)
                                                }
                                                Else
                                                {
                                                    Store (0x01, \_SB.PCI0.LPC.FW3D)
                                                    Store (0x01, IDFU)
                                                }
                                            ...
                                            Case (0x02)
                                            {
                                                If (LEqual (DerefOf (Index (Arg3, 0x00)), 0x00))
                                                {
                                                    Store (0x00, \_SB.PCI0.LPC.CM3D)
                                                }
                                                Else
                                                {
                                                    Store (0x01, \_SB.PCI0.LPC.CM3D)
                                                }
        ...
        Scope (\_SB.PCI0.LPC.EC.HKEY)
        {
            ...
            Method (GWLS, 0, NotSerialized)
            {
                ...
                {
                    Store (0x01, \_SB.PCI0.LPC.EC.RCBD)
                }

                If (\_SB.PCI0.LPC.EC.DCWL)
                {
                    Store (0x01, \_SB.PCI0.LPC.EC.RCWL)
                }

                If (\_SB.PCI0.LPC.EC.DCWW)
                {
                    Store (0x01, \_SB.PCI0.LPC.EC.RCWW)
                }
            ...
            Method (SWLS, 1, NotSerialized)
            {
                If (And (Arg0, 0x01))
                {
                    If (LEqual (\_SB.PCI0.LPC.EC.RCWL, 0x01))
                    {
                        LPWC (0x01)
                    }
                    Else
                    ...
                    If (LEqual (\_SB.PCI0.LPC.EC.RCBD, 0x01))
                    {
                        BPWC (0x01)
                    }
                    Else
                    ...
                    If (LEqual (\_SB.PCI0.LPC.EC.RCWW, 0x01))
                    {
                        WPWC (0x01)
                    }
                    Else
            ...
            Method (SWLN, 1, NotSerialized)
            {
                ...
                {
                    LPWC (0x00)
                    Store (0x00, \_SB.PCI0.LPC.EC.RCWL)
                }
            }
            ...
            Method (SWAN, 1, NotSerialized)
            {
                ...
                {
                    WPWC (0x00)
                    Store (0x00, \_SB.PCI0.LPC.EC.RCWW)
                }
            }
            ...
            Method (SBDC, 1, NotSerialized)
            {
                ...
                {
                    BPWC (0x00)
                    Store (0x00, \_SB.PCI0.LPC.EC.RCBD)
                }
            }
            ...
            Method (WGPS, 1, NotSerialized)
            {
                ...
                {
                    If (LAnd (And (WGFL, 0x10), And (WGFL, 0x0100)))
                    {
                        \BLTH (0x05)
                    }
                }
        ...
        Scope (\_SB.PCI0.VID)
        {
            ...
            Method (ATPX, 2, NotSerialized)
            {
                ...
                If (LEqual (Arg0, 0x02))
                {
                    ...
                    If (Local0)
                    {
                        If (\_SB.PCI0.PEG.VID.ISOP ())
                        {
                            If (LEqual (0x01, \_SB.PCI0.PEG.DGOS))
                            {
                                \VHYB (0x00, 0x01)
                                Sleep (0x7D)
                                \VHYB (0x02, 0x01)
                    ...
                    ElseIf (\_SB.PCI0.PEG.VID.ISOP ())
                    {
                        If (LEqual (0x00, \_SB.PCI0.PEG.DGOS))
                        {
                            If (\_SB.PCI0.LPC.DSPS)
                            {
                                Store (Zero, \_SB.PCI0.LPC.EC.ASBF)
            ...
            {
                 0x01, 0x02, 0x03, 0x80, 0x81, 0x08, 0x09       
            })
    ...
    Method (\_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (Local0)
        {
            ...
            If (LEqual (Arg0, 0x03))
            {
                ...
                If (And (Local1, 0x20))
                {
                    ...
                    {
                        If (LOr (LAnd (\_SB.PCI0.LPC.EC.HB0A, LGreater (And (\_SB.PCI0.LPC.EC.HB0S, 0x07), 0x01)), LAnd (\_SB.PCI0.LPC.EC.HB1A, LGreater (And (\_SB.PCI0.LPC.EC.HB1S, 0x07), 0x01))))
                        {
                            Store (0x00, \FFCL)
                        }
                        Else
        ...
        If (LOr (LEqual (Arg0, 0x05), LEqual (Arg0, 0x04)))
        {
            ...
            {
                \VHYB (0x00, 0x01)
                Store (0x00, \_SB.PCI0.LPC.EC.GATY)
            }
        }

        If (LEqual (\_SB.PCI0.LPC.EC.AAEN, 0x01))
        {
            Store (0x01, RFOF)
    ...
    Method (\_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        If (LLess (Arg0, 0x04))
        {
            If (LOr (And (\RRBF, 0x02), And (\_SB.PCI0.LPC.EC.HWAK, 0x02)))
            {
        ...
        Store (0x00, \_SB.PCI0.LPC.EC.HWAK)
        Store (Zero, \RRBF)
